...
// "invalid arguments" error on failure.
...
type ToolSchema struct {
	...
	Params        []ParamSchema
	Description   string
	ProgressLabel string // shown in progress indicators
...
type Registry struct {
	...
	OnAuthError func(toolName string)
}
...
// SchemasForTools returns schemas for the named subset of tools.
...
// GetProgressLabel returns the progress label for a tool.
...
// DynamicSkillDescriptions returns a formatted "## Skills" section.
...
// Call is a convenience method that marshals args into JSON and invokes the named tool.
...
// against dc before delegating to the registry.
